  ...
  return (
    <main className="min-h-screen bg-slate-950 px-6 py-8 text-slate-100 md:px-10">
      <div className="mx-auto max-w-7xl">
        <header className="mb-10 flex flex-col gap-5 border-b border-slate-800 pb-7 lg:flex-row lg:items-center lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-2xl text-slate-400">
              Real-time intelligence for safer, healthier, and smarter
              communities.
            </p>
          </div>
          ...
          <article className="rounded-2xl border border-slate-800 bg-slate-900 p-6">
            ...
            <div className="mt-5 space-y-4">
              ...
              <div className="border-l-2 border-amber-400 pl-3">
                ...
                <p className="text-sm text-slate-400">Zone E · Moderate severity</p>
              </div>
        ...
        <section className="mt-6 grid gap-6 lg:grid-cols-2">
          <article className="rounded-2xl border border-slate-800 bg-slate-900 p-6">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-lg font-semibold">Community Risk Map</h2>
            </div>
            <div className="mt-5 flex h-64 items-center justify-center rounded-xl border border-dashed border-slate-700 bg-slate-950/60 text-center text-slate-500">
